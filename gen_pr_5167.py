...
script = [
  ...
  {
    "speaker": "Sarah",
    "text": "Exactly. Better setup and troubleshooting docs mean fewer headaches when dealing with multiple currencies."
  }
]
...
async def main():
    ...
    title='PR #5167: Update bank revaluation documentation with enhancements'
