...
script = [
  {
    "speaker": "Andrew",
    "text": "Welcome back to PRCast. Today we're looking at a small but very welcome documentation update over in the unified operations public repo."
  },
  {
    "speaker": "Sarah",
    "text": "That's right, Andrew. We're talking about Pull Request 5166. It's an update to the 'chart accounts delimiter unique' article."
  },
  {
    "speaker": "Andrew",
    "text": "Now, that doesn't exactly roll off the tongue. What's the main change here?"
  },
  {
    "speaker": "Sarah",
    "text": "The gist is that they've made the documentation much more user-friendly. Instead of just dry technical specs, they've added practical usage examples."
  },
  {
    "speaker": "Andrew",
    "text": "Nice! It's always helpful when the docs actually show you how to use the feature in the real world, rather than just telling you what it is."
  },
  {
    "speaker": "Sarah",
    "text": "Exactly. If you're setting up chart of accounts delimiters in Dynamics 365, this update should save you some headaches and guesswork."
  }
]
...
async def main():
    ...
    title='PR #5166: Updated document to be more friendly and give examples'
    desc=('Pull Request by seth-arvila: Updated document to be more friendly and give examples. '
          '1 file changed, +67 -10 lines. Updated chart-accounts-delimiter-unique.md with clearer explanations and usage examples.')
